...
<?= $this->section('tittle'); ?>
<title>Edit Kasir &mdash; Laundry</title>
<?= $this->endSection(); ?>
    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body col-md-6">
                <form action="<?= site_url('admin/updatekasir/' . $kasir->id_kasir) ?>" method="post" autocomplete="off">
                    <input type="hidden" name="_method" value="put">
                    <div class="form-group">
                        <label>Nama Kasir</label>
                        <input type="text" name="username_kasir" class="form-control" required autofocus value="<?= $kasir->username_kasir ?>">
                    </div>
