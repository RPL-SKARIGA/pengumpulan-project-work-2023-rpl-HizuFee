...
<section class="section">
    <div class="section-header">
        <div class="section-header-back">
            <a href="<?= site_url('pesanan') ?>" class="btn btn"><i class="fas fa-arrow-left"></i></a>
        </div>
        <h1>Edit Pesanan</h1>
    </div>
    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body col-md-6">
                <?php if (is_array($row)) : ?>
                    <form action="<?= site_url('admin/update_pesananadm/' . $row['id_pesanan']) ?>" method="post" autocomplete="off">
